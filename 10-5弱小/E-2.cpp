...
struct ax {
    fraction a,b,af,bf; // ax + b + 1/(ax + b)
    int k;
};
...
int main() {
    ...
    while(cin >> s)
    {
        ...
        else if(s[0] == '+')
        {
            ...
            if(num[i].k == 1)
            {
                num[i].a = num[i].a.add(num[j].a);
                num[i].b = num[i].b.add(num[j].b);
                sta.push(i);
            }
            else
            {
                num[j].a = num[j].a.add(num[i].a);
                num[j].b = num[j].b.add(num[i].b);
                sta.push(j);
            }
        }
        else if(s[0] == '-')
        {
            ...
            if(num[i].k == 1)
            {
                num[i].a = num[j].a.sub(num[i].a);
                num[i].b = num[j].b.sub(num[i].b);
                num[i].af = num[i].af.mul(fone);
                num[i].bf = num[i].bf.mul(fone);
                sta.push(i);
            }
            else
            {
                num[j].a = num[j].a.sub(num[i].a);
                num[j].b = num[j].b.sub(num[i].b);
                sta.push(j);
            }
        }
        else if(s[0] == '*')
        {
            ...
            if(num[i].k == 0 && num[j].k == 0)
            {
                ...
                {
                    num[j].a = num[j].a.mul(num[i].b);
                    num[j].b = num[j].b.mul(num[i].b);
                    sta.push(j);
                }
                else if(num[j].a.equal(zero))
                {
                    num[i].a = num[i].a.mul(num[j].b);
                    num[i].b = num[i].b.mul(num[j].b);
                    sta.push(i);
                }
            }
            else
            {
                ...
                {
                    num[i].af = num[i].af.div(num[j].b);
                    num[i].bf = num[i].bf.div(num[j].b);
                }
                sta.push(i);
            }
        }
